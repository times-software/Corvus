...
install script to setup corvus, there should be an executable script named "Corvus.command" or "Corvus.bat" 
on your Desktop. To run corvus, double click this scipt, navigate to the input file you want 
to run, and type,
\begin{verbatim}
run-corvus -i your_input_file
\end{verbatim}
There is also a Corvus\_GUI.command/Corvus\_GUI.bat executable script for running the GUI (see the section on the GUI).
...
your desktop. You can then run a set of the input files using the run\_examples.py
python script,
\begin{verbatim}
